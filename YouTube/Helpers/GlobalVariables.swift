...
struct globalVariables {
    static let urlLink = URL.init(string: "http://xinh.kenh360.com/ActionHandler.ashx?currentPage=0&pageSize=100&categoryId=1&userId=&orderBy=&ActionObject=examination&action=getListImageByPage")!
    static let moreURLLink = URL.init(string: "http://xinh.kenh360.com/ActionHandler.ashx?currentPage=0&pageSize=100&categoryId=1&userId=&orderBy=&ActionObject=examination&action=getListImageByPage")!
